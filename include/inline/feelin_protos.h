...
APTR __F_CreatePoolA(__reg("a6") struct Library *, __reg("d0") uint32 ItemSize, __reg("a0") struct TagItem * Tagl)="\tjsr\t-30(a6)";
#define F_CreatePoolA(ItemSize, Tagl) __F_CreatePoolA(FeelinBase, (ItemSize), (Tagl))
/*
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
APTR __F_CreatePool(__reg("a6") struct Library *, __reg("d0") uint32 ItemSize, ...)="\tmove.l\ta0,-(a7)\n\tlea\t4(a7),a0\n\tjsr\t-30(a6)\n\tmovea.l\t(a7)+,a0";
...
APTR __F_New(__reg("a6") struct Library *, __reg("d0") uint32 Size)="\tjsr\t-72(a6)";
#define F_New(Size) __F_New(FeelinBase, (Size))

APTR __F_NewP(__reg("a6") struct Library *, __reg("a0") APTR Pool, __reg("d0") uint32 Size)="\tjsr\t-78(a6)";
...
STRPTR __F_StrFmtA(__reg("a6") struct Library *, __reg("a0") APTR Buffer, __reg("a1") STRPTR Fmt, __reg("a2") int32 * Params)="\tjsr\t-162(a6)";
#define F_StrFmtA(Buffer, Fmt, Params) __F_StrFmtA(FeelinBase, (Buffer), (Fmt), (Params))
/*
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
uint32 __F_StrFmt(__reg("a6") struct Library *, __reg("a0") APTR Buffer, __reg("a1") STRPTR Fmt, ...)="\tmove.l\ta2,-(a7)\n\tlea\t4(a7),a2\n\tjsr\t-162(a6)\n\tmovea.l\t(a7)+,a2";
#define F_StrFmt(Buffer, ...) __F_StrFmt(FeelinBase, (Buffer), __VA_ARGS__)
#endif
*/
STRPTR __F_StrNewA(__reg("a6") struct Library *, __reg("a0") uint32 * Lengthptr, __reg("a1") STRPTR Fmt, __reg("a2") int32 * Params)="\tjsr\t-168(a6)";
...
(
    ...
    __reg("a0") APTR Pool,
    __reg("a1") uint32 * Lengthptr,
    __reg("a2") STRPTR Fmt,
    __reg("a3") int32 * Params
) = "\tjsr\t-432(a6)";

#define F_StrNewPA(Pool, Lengthptr, Fmt, Params) __F_StrNewPA(FeelinBase, (Pool), (Lengthptr), (Fmt), (Params))

/*
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
STRPTR __F_StrNew(__reg("a6") struct Library *, __reg("a0") uint32 * Lengthptr, __reg("a1") STRPTR Fmt, ...)="\tmove.l\ta2,-(a7)\n\tlea\t4(a7),a2\n\tjsr\t-168(a6)\n\tmovea.l\t(a7)+,a2";
#define F_StrNew(Lengthptr, ...) __F_StrNew(FeelinBase, (Lengthptr), __VA_ARGS__)
#endif
*/
uint32 __F_StrLen(__reg("a6") struct Library *, __reg("a0") STRPTR Str)="\tjsr\t-174(a6)";
#define F_StrLen(Str) __F_StrLen(FeelinBase, (Str))

int32 __F_StrCmp(__reg("a6") struct Library *, __reg("a0") STRPTR Str1, __reg("a1") STRPTR Str2, __reg("d1") uint32 Length)="\tjsr\t-180(a6)";
#define F_StrCmp(Str1, Str2, Length) __F_StrCmp(FeelinBase, (Str1), (Str2), (Length))

void __F_LogA(__reg("a6") struct Library *, __reg("d0") uint32 Level, __reg("a0") STRPTR Fmt, __reg("a1") int32 * Params)="\tjsr\t-186(a6)";
#define F_LogA(Level, Fmt, Params) __F_LogA(FeelinBase, (Level), (Fmt), (Params))
/*
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
void __F_Log(__reg("a6") struct Library *, __reg("d0") uint32 Level, __reg("a0") STRPTR Fmt, ...)="\tmove.l\ta1,-(a7)\n\tlea\t4(a7),a1\n\tjsr\t-186(a6)\n\tmovea.l\t(a7)+,a1";
#define F_Log(Level, ...) __F_Log(FeelinBase, (Level), __VA_ARGS__)
#endif
*/
void __F_AlertA(__reg("a6") struct Library *, __reg("a0") STRPTR Title, __reg("a1") STRPTR Body, __reg("a2") int32 * Params)="\tjsr\t-192(a6)";
...
#endif
*/
FHashTable * __F_HashCreate(__reg("a6") struct Library *, __reg("d0") uint32 Size)="\tjsr\t-198(a6)";
...
FHashLink * __F_HashFind(__reg("a6") struct Library *, __reg("a0") FHashTable * Table, __reg("a1") UBYTE * Key, __reg("d1") uint32 KeyLength, __reg("a2") uint32 * HashValuePtr)="\tjsr\t-210(a6)";
...
FHashLink * __F_HashAdd(__reg("a6") struct Library *, __reg("a0") FHashTable * Table, __reg("a1") UBYTE * Key, __reg("d0") uint32 KeyLength, __reg("a2") APTR Data)="\tjsr\t-228(a6)";
#define F_HashAdd(Table, Key, KeyLength, Data) __F_HashAdd(FeelinBase, (Table), (Key), (KeyLength), (Data))

void __F_HashRem(__reg("a6") struct Library *, __reg("a0") FHashTable * Table, __reg("a1") UBYTE * Key, __reg("d0") uint32 KeyLength)="\tjsr\t-234(a6)";
#define F_HashRem(Table, Key, KeyLength) __F_HashRem(FeelinBase, (Table), (Key), (KeyLength))

int32 __F_DynamicCreate(__reg("a6") struct Library *, __reg("a0") FClass * feelin_class)="\tjsr\t-240(a6)";
...
uint32 __F_DynamicFindID(__reg("a6") struct Library *, __reg("a0") STRPTR Name)="\tjsr\t-264(a6)";
...
int32 __F_DynamicAddAutoTable(__reg("a6") struct Library *, __reg("a0") FDynamicEntry * Table)="\tjsr\t-276(a6)";
...
struct TagItem * __F_DynamicFTI(__reg("a6") struct Library *, __reg("d0") uint32 Attribute, __reg("a0") struct TagItem * Tagl)="\tjsr\t-294(a6)";
#define F_DynamicFTI(Attribute, Tagl) __F_DynamicFTI(FeelinBase, (Attribute), (Tagl))

uint32 __F_DynamicGTD(__reg("a6") struct Library *, __reg("d0") uint32 Attribute, __reg("d1") uint32 DefaultValue, __reg("a0") struct TagItem * Tagl)="\tjsr\t-300(a6)";
...
uint32 __F_DoA(__reg("a6") struct Library *, __reg("a0") FObject Obj, __reg("d0") uint32 Method, __reg("a1") APTR Msg)="\tjsr\t-336(a6)";
#define F_DoA(Obj, Method, Msg) __F_DoA(FeelinBase, (Obj), (Method), (Msg))
/*
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
uint32 __F_Do(__reg("a6") struct Library *, __reg("a0") FObject Obj, __reg("d0") uint32 Method, ...)="\tmove.l\ta1,-(a7)\n\tlea\t4(a7),a1\n\tjsr\t-336(a6)\n\tmovea.l\t(a7)+,a1";
#define F_Do(Obj, ...) __F_Do(FeelinBase, (Obj), __VA_ARGS__)
#endif
*/
uint32 __F_ClassDoA(__reg("a6") struct Library *, __reg("a2") FClass * feelin_class, __reg("a0") FObject Obj, __reg("d0") uint32 Method, __reg("a1") APTR Msg)="\tjsr\t-342(a6)";
#define F_ClassDoA(feelin_class, Obj, Method, Msg) __F_ClassDoA(FeelinBase, (feelin_class), (Obj), (Method), (Msg))
/*
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
uint32 __F_ClassDo(__reg("a6") struct Library *, __reg("a2") FClass * feelin_class, __reg("a0") FObject Obj, __reg("d0") uint32 Method, ...)="\tmove.l\ta1,-(a7)\n\tlea\t4(a7),a1\n\tjsr\t-342(a6)\n\tmovea.l\t(a7)+,a1";
#define F_ClassDo(feelin_class, Obj, ...) __F_ClassDo(FeelinBase, (feelin_class), (Obj), __VA_ARGS__)
#endif
*/
uint32 __F_SuperDoA(__reg("a6") struct Library *, __reg("a2") FClass * feelin_class, __reg("a0") FObject Obj, __reg("d0") uint32 Method, __reg("a1") APTR Msg)="\tjsr\t-348(a6)";
#define F_SuperDoA(feelin_class, Obj, Method, Msg) __F_SuperDoA(FeelinBase, (feelin_class), (Obj), (Method), (Msg))
/*
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
uint32 __F_SuperDo(__reg("a6") struct Library *, __reg("a2") FClass * feelin_class, __reg("a0") FObject Obj, __reg("d0") uint32 Method, ...)="\tmove.l\ta1,-(a7)\n\tlea\t4(a7),a1\n\tjsr\t-348(a6)\n\tmovea.l\t(a7)+,a1";
...
#endif
*/
FObject __F_MakeObjA(__reg("a6") struct Library *, __reg("d0") uint32 Type, __reg("a0") uint32 * Params)="\tjsr\t-360(a6)";
#define F_MakeObjA(Type, Params) __F_MakeObjA(FeelinBase, (Type), (Params))
/*
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
FObject __F_MakeObj(__reg("a6") struct Library *, __reg("d0") uint32 Type, ...)="\tmove.l\ta0,-(a7)\n\tlea\t4(a7),a0\n\tjsr\t-360(a6)\n\tmovea.l\t(a7)+,a0";
...
uint32 __F_Get(__reg("a6") struct Library *, __reg("a0") FObject Obj, __reg("d1") uint32 Attribute)="\tjsr\t-372(a6)";
#define F_Get(Obj, Attribute) __F_Get(FeelinBase, (Obj), (Attribute))

void __F_Set(__reg("a6") struct Library *, __reg("a0") FObject Obj, __reg("d1") uint32 Attribute, __reg("d2") uint32 Value)="\tjsr\t-378(a6)";
#define F_Set(Obj, Attribute, Value) __F_Set(FeelinBase, (Obj), (Attribute), (Value))

void __F_Draw(__reg("a6") struct Library *, __reg("a0") FObject Obj, __reg("d0") uint32 Flags)="\tjsr\t-384(a6)";
#define F_Draw(Obj, Flags) __F_Draw(FeelinBase, (Obj), (Flags))

void __F_Layout(__reg("a6") struct Library *, __reg("a0") FObject Obj, __reg("d0") int16 X, __reg("d1") int16 Y, __reg("d2") uint16 W, __reg("d3") uint16 H, __reg("d4") uint32 Flags)="\tjsr\t-390(a6)";
#define F_Layout(Obj, X, Y, W, H, Flags) __F_Layout(FeelinBase, (Obj), (X), (Y), (W), (H), (Flags))

void __F_Erase(__reg("a6") struct Library *, __reg("a0") FObject Obj, __reg("d0") int16 X1, __reg("d1") int16 Y1, __reg("d2") int16 X2, __reg("d3") int16 Y2, __reg("d4") uint32 Flags)="\tjsr\t-396(a6)";
