...
#undef F_StrNewPA
#define F_StrNewPA(__p0, __p1, __p2, __p3) \
	LP4(432, STRPTR , F_StrNewPA, \
		APTR, __p0, a0, \
		uint32 *, __p1, a1, \
		STRPTR , __p2, a2, \
		int32 *, __p3, a3, \
...
#undef F_AtomFind
#define F_AtomFind(__p0, __p1) \
	LP2(438, FAtom *, F_AtomFind, \
		STRPTR, __p0, a0, \
		uint32, __p1, d0, \
		, FEELIN_BASE_NAME)

#undef F_AtomObtain
#define F_AtomObtain(__p0, __p1) \
	LP2(444, FAtom *, F_AtomObtain, \
		STRPTR, __p0, a0, \
		uint32, __p1, d0, \
		, FEELIN_BASE_NAME)

#undef F_AtomRelease
#define F_AtomRelease(__p0) \
	LP1NR(450, F_AtomRelease, \
		FAtom *, __p0, a0, \
		, FEELIN_BASE_NAME)

#undef F_AtomCreatePool
#define F_AtomCreatePool() \
	LP0(456, APTR, F_AtomCreatePool, \
		, FEELIN_BASE_NAME)

#undef F_AtomDeletePool
#define F_AtomDeletePool(__p0) \
	LP1NR(462, F_AtomDeletePool, \
		APTR, __p0, a0, \
		, FEELIN_BASE_NAME)

#undef F_AtomFindP
#define F_AtomFindP(__p0, __p1, __p2) \
	LP3(468, FAtom *, F_AtomFindP, \
		APTR, __p0, a0, \
		STRPTR, __p1, a1, \
		uint32, __p2, d0, \
		, FEELIN_BASE_NAME)
...
#undef F_AtomObtainP
#define F_AtomObtainP(__p0, __p1, __p2) \
	LP3(474, FAtom *, F_AtomObtainP, \
		APTR, __p0, a0, \
		STRPTR, __p1, a1, \
		uint32, __p2, d0, \
		, FEELIN_BASE_NAME)

#undef F_AtomReleaseP
#define F_AtomReleaseP(__p0, __p1) \
	LP2NR(480, F_AtomReleaseP, \
		APTR, __p0, a0, \
		FAtom *, __p1, a1, \
		, FEELIN_BASE_NAME)
...
#undef F_StrNewP
#define F_StrNewP(__p0, __p1, __p2, ...) \
	({uint32 _tags[] = { __VA_ARGS__ }; \
	F_StrNewA(__p0, __p1, __p2, (int32 *)_tags);})
