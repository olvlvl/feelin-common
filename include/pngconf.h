...
#define PNG_NO_WRITE_SUPPORTED  // turn off write support
#define PNG_NO_FLOATING_POINT_SUPPORTED // turn off floating points
...
#define PNG_FOR_FEELIN

#ifdef PNG_FOR_FEELIN
