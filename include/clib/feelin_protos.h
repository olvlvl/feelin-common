...
STRPTR                  F_StrNewPA              (APTR Pool,uint32 *Len,STRPTR Fmt,int32 *Params);
...
/* FIXME: F_DynamicCreate & F_DynamicDelete should be private functions */
...
FAtom *                 F_AtomFind              (STRPTR Str, uint32 Length);
FAtom *                 F_AtomObtain            (STRPTR Str, uint32 Length);
void                    F_AtomRelease           (FAtom *Atom);
APTR                    F_AtomCreatePool        (void);
void                    F_AtomDeletePool        (APTR Pool);
FAtom *                 F_AtomFindP             (APTR Pool, STRPTR Str, uint32 Length);
FAtom *                 F_AtomObtainP           (APTR Pool, STRPTR Str, uint32 Length);
void                    F_AtomReleaseP          (APTR Pool, FAtom *Atom);

#ifndef NO_TAG_CALL
APTR                    F_CreatePool            (uint32 ItemSize,...);
STRPTR                  F_StrNew                (uint32 *Len,STRPTR Fmt,...);
STRPTR                  F_StrNewP               (APTR Pool,uint32 *Len,STRPTR Fmt,...);
