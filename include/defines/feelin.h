...
#define F_StrNewPA(___Pool, ___Lengthptr, ___Fmt, ___Params) \
    AROS_LC4(STRPTR, F_StrNewPA, \
    AROS_LCA(APTR, (___Pool), A0), \
    AROS_LCA(uint32 *, (___Lengthptr), A1), \
    AROS_LCA(STRPTR, (___Fmt), A2), \
    AROS_LCA(int32 *, (___Params), A3), \
    struct Library *, FEELIN_BASE_NAME, 72, /* s */)
